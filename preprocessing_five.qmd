---
title: "Chapter Five: Combining Updated Locations Data with Initial Trip Data"
execute: 
  eval: false
  output: true
format: 
...
This will be the last chapter for me, but please go further — create maps based on this data, and perform machine learning analysis too. You can find **Sparklyr machine learning documentation [here](https://spark.rstudio.com/guides/machine-learning/)**.
